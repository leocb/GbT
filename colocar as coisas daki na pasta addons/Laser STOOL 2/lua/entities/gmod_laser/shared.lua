...
function ENT:SetDissolveType( dissolvetype )
	self.Entity:SetNetworkedString( "DissolveType", dissolvetype );
end

function ENT:GetDissolveType()
	local dissolvetype = self.Entity:GetNetworkedString( "DissolveType" );
...
function ENT:SetToggle( bool )
	self.Entity:SetNetworkedBool( "Toggle", bool );
end
...
function ENT:SetPushProps( bool )
	self.Entity:SetNetworkedBool( "PushProps", bool );
end

function ENT:GetPushProps()
	return self.Entity:GetNetworkedBool( "PushProps" );
end
