...
if ( CLIENT ) then
    language.Add( "Tool_laseremitter_name", "Laser Spawner" );
    language.Add( "Tool_laseremitter_desc", "Spawn a very dangerous laser. Do not look into beam with remaining eye!" );
    language.Add( "Tool_laseremitter_0", "Primary: Create/Update a laser where you are aiming" );
...
list.Set( "LaserEmitterMaterials", {}, "effects/redlaser1" );
...
if (SERVER) then
	...
	function MakeLaserEmitter(	ply, pos, ang, model, angleOffset, key, width, length, damage, material, dissolveType,
	...
	duplicator.RegisterEntityClass(	"gmod_laser", MakeLaserEmitter, "pos", "ang", "model", "angleOffset", "key", "width", "length",
